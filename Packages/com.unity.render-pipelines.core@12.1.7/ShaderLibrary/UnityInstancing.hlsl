...
// instanced property arrays
    ...
    #ifdef UNITY_INSTANCED_LIGHT_DATA
        #define UNITY_USE_LIGHTDATA_ARRAY
    #endif
    ...
    UNITY_INSTANCING_BUFFER_START(PerDraw2)
        ...
        #endif
        #ifdef UNITY_USE_LIGHTDATA_ARRAY
            UNITY_DEFINE_INSTANCED_PROP(half4, unity_LightDataArray)
            UNITY_DEFINE_INSTANCED_PROP(half4, unity_LightIndices0Array)
            UNITY_DEFINE_INSTANCED_PROP(half4, unity_LightIndices1Array)
            #define unity_LightData UNITY_ACCESS_INSTANCED_PROP(unity_Builtins2, unity_LightDataArray)
            #define unity_LightIndices0 UNITY_ACCESS_INSTANCED_PROP(unity_Builtins2, unity_LightIndices0Array)
            #define unity_LightIndices1 UNITY_ACCESS_INSTANCED_PROP(unity_Builtins2, unity_LightIndices1Array)
        #endif
